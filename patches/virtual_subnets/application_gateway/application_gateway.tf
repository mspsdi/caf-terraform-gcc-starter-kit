...
resource "azurerm_application_gateway" "agw" {
  ...
  dynamic "frontend_ip_configuration" {
    ...
    content {
      ...
      subnet_id                     = try(local.ip_configuration[frontend_ip_configuration.key].subnet_id,var.virtual_subnets[try(frontend_ip_configuration.value.lz_key, var.client_config.landingzone_key)][frontend_ip_configuration.value.virtual_subnet_key].id)
    }
  }
