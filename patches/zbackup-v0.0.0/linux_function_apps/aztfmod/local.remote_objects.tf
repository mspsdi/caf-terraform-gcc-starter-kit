locals {
  remote_objects = {
    ...
    cognitive_deployments                          = try(local.combined_objects_cognitive_deployments, null)
    # openai_services                                = try(local.combined_objects_openai_services, null)
    search_services                                = try(local.combined_objects_search_services, null)
    # openai                                         = try(local.combined_objects_openai, null)
