...
locals {
  ...
  cognitive_services = {
    ...
    cognitive_deployments = try(var.cognitive_services.cognitive_deployments, {})
    # openai_services = try(var.cognitive_services.openais, {})
    search_services = try(var.cognitive_services.search_services, {})       
  }

  # # TODO: remove 
  # openai_services = {
  #   openai = try(var.openai_services.openai, {})
  #   search_service = try(var.openai_services.search_service, {})   
  # }
  ...
  webapp = {
    ...
    linux_function_apps                            = try(var.webapp.linux_function_apps, {}) # 24 Oct 2023
