  ...
  web_nsg = {
    ...
    nsg = [
      ...
      # source Internet destination Any : source MUST be Internet and destination MUST be *
      {
        ...
        source_address_prefix      = "GatewayManager" # "Internet" # MUST be Internet - GatewayManager
      ...
      # do not change
      # inbound https 443 management infra "100.3.0.0/26" > web "100.1.0.64/26"          
      {
        ...
        destination_address_prefix = "100.1.0.64/26"
      }, 
      # do not change      
      # inbound http 80 management infra "100.3.0.0/26" > web "100.1.0.64/26"          
      {
      ...
      # do not change            
      # inbound ssh 22 management bastion "100.3.0.128/26" > web "100.1.0.64/26"          
      {
    ...
    # begin web inbound   
      # inbound https 443 ingress "100.1.0.0/25" > web "100.1.0.64/26"      
      {
        ...
        source_port_range          = "*"
        destination_port_range     = "443"
        source_address_prefix      = "100.1.0.0/26"
        destination_address_prefix = "100.1.0.64/26"
      },
      # inbound http 80-82 ingress "100.1.0.0/25" > web "100.1.0.64/26"       
      {
      ...
      # inbound http 8080-8082 ingress "100.1.0.0/25" > web "100.1.0.64/26"       
      {
    ...
    # begin management outbound
      ...
      # do not change
      # outbound https 443 web "100.1.0.64/26" > management infra "100.3.0.0/26"
      {
    ...
    # begin web outbound
      # outbound https 443 web "100.1.0.64/26" > app "100.2.0.0/27"
      {
      ...
      # outbound http 8080 web "100.1.0.64/26" > app "100.2.0.0/27"
      {
      ...
      # outbound http 80-82 web "100.1.0.64/26" > app "100.2.0.0/27"
      {
