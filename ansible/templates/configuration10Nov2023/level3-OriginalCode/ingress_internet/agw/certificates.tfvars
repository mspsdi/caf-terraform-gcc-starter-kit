keyvault_certificates = {
  "openai.internet.rsaf.gov.sg" = { # TODO: ssl cert for appgateway

    keyvault_key = "certificates"

    # may only contain alphanumeric characters and dashes
    name = "openai-keyvault-certificates"
  ...
  "aks-openai.internet.rsaf.gov.sg" = { # TODO: ssl cert for aks

    keyvault_key = "certificates"

    # may only contain alphanumeric characters and dashes
    name = "aks-openai-keyvault-certificates"

    subject            = "CN=aks-openai"
    validity_in_months = 12
    ...
    subject_alternative_names = {
      ...
      # Changing this forces a new resource to be created.
      dns_names = [
        "aks-openai.internet.rsaf.gov.sg"
      ]
