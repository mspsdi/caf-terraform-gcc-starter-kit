...
# az network firewall network-rule create -g $RG -f $FWNAME --collection-name 'aksfwnr' -n 'time' --protocols 'UDP' --source-addresses '*' --destination-fqdns 'ntp.ubuntu.com' --destination-ports 123
  ...
  app_nsg = {
    ...
    # begin management inbound
      ...
      #   source_port_range          = "*"
      #   destination_port_range     = "*"
      #   source_address_prefix      = "100.2.0.0/27"
      #   destination_address_prefix = "172.16.5.0/24"
      # },  
      # do not change
      # inbound https 443 management infra "100.3.0.0/26" > app "100.2.0.0/27"          
      {
      ...
      # do not change      
      # inbound http 80 management infra "100.3.0.0/26" > app "100.2.0.0/27"          
      {
      ...
      # do not change            
      # inbound ssh 22 management bastion "100.3.0.128/26" > app "100.2.0.0/27"          
      {
    ...
    # begin ingress inbound             
      # inbound https 443 internet agw web "100.1.0.64/26" > app "100.2.0.0/27"      
      {
        ...
        source_port_range          = "*"
        destination_port_range     = "443"
        source_address_prefix      = "100.1.0.64/26"
        destination_address_prefix = "100.2.0.0/27"
      },
      # inbound http 80-82 internet agw web "100.1.0.64/26" > app "100.2.0.0/27" - optional      
      {
      ...
      # inbound http 8080-8082 internet agw  web "100.1.0.64/26" > app "100.2.0.0/27" - optional  
      {
      ...
      # inbound https 443 intranet agw web "10.2.0.64/27" > app "100.2.0.0/27"      
      {
      ...
      # inbound http 80-82 intranet agw web "10.2.0.64/27" > app "100.2.0.0/27" - optional     
      {
      ...
      # inbound http 8080-8082 intranet agw  web "10.2.0.64/27" > app "100.2.0.0/27" - optional  
      {
      ...
      # source devpps destination app cidr 
      {
        ...
        destination_address_prefix = "100.2.0.0/27" # app CIDR        
      },            
...
# time ntp.ubuntu.com UDP 123 
    ...
    # # end aks FQDN requirements  
      ...
      # do not change
      # outbound https 443 app "100.2.0.0/27" > management infra "100.3.0.0/26"
      {
      ...
      # outbound SQL Server 1443 app "100.2.0.0/27" > db "100.2.0.32/27"
      {
        ...
        source_address_prefix      = "100.2.0.0/27"
        destination_address_prefix = "100.2.0.32/27"
      },
      # outbound postgresql 5432 app "100.2.0.0/27" > db "100.2.0.32/27"
      {
      ...
      # outbound redis caches 6380-6383 app "100.2.0.0/27" > db "100.2.0.32/27"
      {
      ...
      # outbound to egress firewall internet * app "100.2.0.0/27" > egress firewall "100.1.1.0/26"
      {
        ...
        destination_port_range     = "*"
        source_address_prefix      = "100.2.0.0/27"
        destination_address_prefix = "100.1.1.0/26"
      },       
  ...
  db_nsg = {
    ...
    # management inbound
       # do not change            
      # inbound ssh 22 management bastion "100.3.0.128/26" > db "100.2.0.0/27"          
      {
    ...
    # end management inbound   
      # inbound mssql 1433 app "100.2.0.0/27" > db "100.2.0.32/27"         
      {
      ...
      # inbound postgresql 5432 app "100.2.0.0/27" > db "100.2.0.32/27"        
      {
      ...
      # inbound Redis 6380-6383 app "100.2.0.0/27" > db "100.2.0.32/27"        
      {
