      ...
      rule1 = { # this may not be required.
        ...
        rules = {
          rule1 = {
            ...
            source_addresses  = ["*"]
            destination_fqdns = ["demoapp1.intranet.caflabs.com"] # TODO: change to your applicaiton fdqn
          }
        }
      }
    }
      ...
      group1 = {
        ...
        rules = {
          rule1 = {
            ...
            translated_address                = "10.2.0.74" # TODO: Add private ip of intranet app gw
            translated_port                   = "443"
          }
