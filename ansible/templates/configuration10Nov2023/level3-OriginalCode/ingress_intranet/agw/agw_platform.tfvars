...
application_gateway_platforms = {
  agw1 = {
    ...
    #     subnet_id = "/subscriptions/6f035180-4066-42f0-b0fa-5fbc1ae67500/resourceGroups/gcci-platform/providers/Microsoft.Network/virtualNetworks/gcci-vnet-ingress-intranet/subnets/escep-snet-ingress-agw"
    ...
    front_end_ip_configurations = {
      ...
      private = {
        ...
        lz_key = "networking_hub_intranet"    
        #             subnet_id = "/subscriptions/6f035180-4066-42f0-b0fa-5fbc1ae67500/resourceGroups/gcci-platform/providers/Microsoft.Network/virtualNetworks/gcci-vnet-ingress-intranet/subnets/escep-snet-ingress-agw"
        subnet_cidr = "10.2.0.64/27" # TODO: set the web subnet cidr range - hardcoded here         
    ...
    tags = { 
      purpose = "intranet web reverse proxy application gateway" 
      project-code = "escep" 
      env = "uat" 
      zone = "intranet"
      tier = "ingress"           
