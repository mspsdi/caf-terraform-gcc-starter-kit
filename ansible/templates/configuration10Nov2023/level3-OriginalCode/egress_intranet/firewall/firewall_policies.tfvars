      ...
      group1 = {
        ...
        rules = {
          ...
          apex = { # api
            ...
            destination_addresses = [
              "10.0.0.5" # TODO: set the apex ip addresses or on-prem ip addresses.
            ]
            protocols = [
              "TCP",
            ]
          ...
          #   ]
          #   destination_addresses = [
          #     "10.0.0.6" # TODO: set the astra ip addresses or on-prem ip addresses.
          #   ]
          #   protocols = [
          #     "TCP",
          #   ]
          ...
          #   ]
          #   destination_addresses = [
          #     "10.0.0.7" # TODO: set the astra ip addresses or on-prem ip addresses.
          #   ]
          #   protocols = [
          #     "TCP",
          #   ]
